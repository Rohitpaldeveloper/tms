                ...
                <div class="card-body">
                  <form class="form-sample"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-6 pl-md-0">
                        <label class="col-sm-12 pl-0 pr-0">Outdoor / Indoor</label>
                        <div class="col-sm-12 pl-0 pr-0">
                          <input type="text" class="form-control" name="packagetype" id="packagetype" placeholder="Outdoor / Indoor" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="form-group col-md-6 pl-md-0">
                      <label class="col-sm-12 pl-0 pr-0">Price in ₹</label>
                      <div class="col-sm-12 pl-0 pr-0">
                  ...
                  <div class="row">  
                    <div class="form-group col-md-4 ">
                      <label class="col-sm-12 pl-0 pr-0 ">Choose Image</label>
                      <div class="col-sm-12 pl-0 pr-0">
