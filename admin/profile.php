                        ...
                        <div class="container rounded bg-white mt-5">
                          ...
                          <div class="col-md-8">
                            <div class="p-3 py-5">
                              ...
                              <div class="row mt-2">
                                <div class="col-md-6"><input type="text" class="form-control" name="firstname" value="<?php  echo $row->FirstName;?>" readonly="true"></div>
                                <div class="col-md-6"><input type="text" class="form-control" value="<?php  echo $row->LastName;?> " name="lastname" readonly="true"></div>
                              </div>
                              <div class="row mt-3">
                                <div class="col-md-6"><input type="text" class="form-control" name="email" value="<?php  echo $row->Email;?>" readonly="true"></div>
                                <div class="col-md-6"><input type="text" class="form-control" value="0<?php  echo $row->MobileNumber;?>" name="mobilenumber" readonly="true"></div>
                              </div>
                              <div class="row mt-3">
                                <div class="col-md-6">
                                  <label class="form-group">User Name</label>
                                  <input type="text" class="form-control" name="username" value="<?php  echo $row->UserName;?>" readonly="true"></div>
                                  <div class="col-md-6">
