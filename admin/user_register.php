                        ...
                        {    
                          ...
                          <tr>
                            ...
                            <td class=" text-center">
                              ...
                              <!-- <a href="user_register.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');" title="Delete this User" class="btn btn-sm btn-danger">Block</a>  -->
                            </td>
                            </tr>
                            <?php $cnt=$cnt+1;
                          }
